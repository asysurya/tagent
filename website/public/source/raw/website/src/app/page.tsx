...
import {
  ...
  IconMonitor, IconRefresh, IconCheck, IconBranch, IconCode,
...
./tagent start --web-gui           # TUI + browser GUI`}</Code>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg px-5 py-2.5 text-sm font-semibold text-zinc-400 transition hover:text-zinc-200"
            >
              <IconCode className="size-4" width={16} height={16} />
              Source
            </Link>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden border-t border-zinc-800/60">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-24 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Link
              href="/source"
              className="inline-flex items-center gap-2 rounded-lg px-5 py-2.5 text-sm font-semibold text-zinc-400 transition hover:text-orange-300"
            >
              <IconCode className="size-4" width={16} height={16} />
              Browse the source
            </Link>
